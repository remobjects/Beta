...
type
  ...
  public
    method initWithMessage(aMessage: not nullable ROMessage) channel(aChannel: not nullable ROClientChannel): dynamic; override;
    method __getInterfaceName: not nullable NSString; override;
    method registerDevice(
      deviceToken: NSData;
      additionalInfo: String
    );
...
method ApplePushProviderService_Proxy.initWithMessage(aMessage: not nullable ROMessage) channel(aChannel: not nullable ROClientChannel): dynamic;
begin
  exit inherited initWithMessage(aMessage) channel(aChannel);
end;

method ApplePushProviderService_Proxy.__getInterfaceName: not nullable NSString;
begin
...
method ApplePushProviderService_AsyncProxy.initWithMessage(aMessage: not nullable ROMessage) channel(aChannel: not nullable ROClientChannel): dynamic;
begin
  exit inherited initWithMessage(aMessage) channel(aChannel);
end;

method ApplePushProviderService_AsyncProxy.__getInterfaceName: not nullable NSString;
begin
  exit "ApplePushProviderService";
end;
...
method GooglePushProviderService_Proxy.initWithMessage(aMessage: not nullable ROMessage) channel(aChannel: not nullable ROClientChannel): dynamic;
begin
  exit inherited initWithMessage(aMessage) channel(aChannel);
end;

method GooglePushProviderService_Proxy.__getInterfaceName: not nullable NSString;
begin
...
method GooglePushProviderService_AsyncProxy.initWithMessage(aMessage: not nullable ROMessage) channel(aChannel: not nullable ROClientChannel): dynamic;
begin
  exit inherited initWithMessage(aMessage) channel(aChannel);
end;

method GooglePushProviderService_AsyncProxy.__getInterfaceName: not nullable NSString;
begin
  exit "GooglePushProviderService";
end;
